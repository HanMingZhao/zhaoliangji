...
'''
scur.execute(weekSaleSql.format('2017-12-1', '2018-1-1'))
...
ORDER BY `count` DESC
'''
scur.execute(versionSql.format('2017-12-1', '2018-1-1'))
...
AND oo.order_type in (1,2)
'''
scur.execute(featureSql.format('2017-12-1', '2018-1-1', ''))
...
scur.execute(saleCountSql.format('2017-12-1', '2018-1-1',
...
GROUP BY `time`
'''
scur.execute(groundingSql.format('2017-12-1', '2018-1-1'))
result = scur.fetchall()
